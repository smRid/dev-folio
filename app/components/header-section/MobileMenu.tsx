...
export default function MobileMenu({
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="grid  z-10 items-center grid-cols-2 sm:hidden px-6 py-5 fixed top-12 rounded-2xl bg-linear-to-r from-[#28198a6b]  max-w-[90%] w-full to-[#1b17171f] mt-12 sm:mt-16 std-backdrop-blur"
    >
      <ul
