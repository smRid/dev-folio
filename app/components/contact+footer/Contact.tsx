      ...
      >
        {!formDisplay ? (
          ...
          >
            ...
            <Link href="#footer">
              <button
                className={`text-xl ml-auto mt-6 lg:ml-0 block sm:hidden lg:block lg:text-2xl font-semibold px-4 py-2 md:px-3 lg:py-4 lg:mt-12 rounded-xl border-2 border-white leading-none cursor-pointer hover:bg-white/10 transition-colors ${
            ...
            >
              ...
              <div className="flex items-center h-full gap-2 w-full">
                ...
                >
                  ...
                  <button
                    className={`rounded-md bg-linear-to-r from-[#d9d9d91f] to-[#7373731f] py-3 px-5 ${syne.className} font-bold uppercase mt-4 cursor-pointer`}
                  >
                    Send
                  </button>
                </form>
