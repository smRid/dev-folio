...
const TimelineData = [
  ...
  // },
  {
    ...
    stuffIDid: [
      "Developed responsive web applications using React.js, TailwindCSS, and JavaScript.",
      "Collaborated with the design team to implement modern, user-friendly UI components.",
      "Improved performance and responsiveness across desktop and mobile platforms.",
      "Participated in code reviews and team meetings to enhance development workflows.",
    ],
  },
];
